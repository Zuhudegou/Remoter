...
void Set_USBClock(void)
{
  // Select USBCLK source 
		 if( GetSystemCoreClock() == 72000000 ){
					RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_1Div5);  //  sysclk(72MHz)/1.5=48MHz   1Div5=1.5
		 }
		 //新增，内部晶振时，系统时钟为48MHz，无法上到72MHz
		 else{
					RCC_USBCLKConfig(RCC_USBCLKSource_PLLCLK_Div1);   //  sysclk(48MHz)/1.0=48MHz   1Div5=1.0
		 }
